...
public class Main
{
    public static void main(final String[] array) {
        ...
        final ArgumentAcceptingOptionSpec defaultsTo3 = optionParser.accepts("username").withRequiredArg().defaultsTo((Object)("Player" + Minecraft.IIIllllllIllIIIlllIl() % 1000L), (Object[])new String[0]);
        ...
        if (!no_PROXY.equals(Proxy.NO_PROXY) && llllIIIIlIIIlIlllIll(s2) && llllIIIIlIIIlIlllIll(s3)) {
            Authenticator.setDefault(new llllIIIlIlllIlIIIIIl(s2, s3));
        }
        ...
        final llllIIIIlIIIlIlllIll llllIIIIlIIIlIlllIll = new llllIIIIlIIIlIlllIll(new IllIIlllIIIIlllIIlIl(new Session((String)((OptionSpec)defaultsTo3).value(parse), parse.has((OptionSpec)withRequiredArg5) ? ((String)((OptionSpec)withRequiredArg5).value(parse)) : ((String)((OptionSpec)defaultsTo3).value(parse)), (String)((OptionSpec)required).value(parse), (String)((OptionSpec)defaultsTo8).value(parse)), propertyMap, propertyMap2, no_PROXY), new IlIlIlIlIlllllllllIl(intValue, intValue2, has, has2), new llIllIIIIIllIlIIIIlI(file, parse.has((OptionSpec)ofType2) ? ((File)parse.valueOf((OptionSpec)ofType2)) : new File(file, "resourcepacks/"), parse.has((OptionSpec)ofType) ? ((File)parse.valueOf((OptionSpec)ofType)) : new File(file, "assets/"), parse.has((OptionSpec)withRequiredArg6) ? ((String)((OptionSpec)withRequiredArg6).value(parse)) : null), new IlIIIlIlIIIllIlIlIIl(has3, s4), new IlIlIIIllIllIIIIIllI((String)parse.valueOf((OptionSpec)withRequiredArg), (int)parse.valueOf((OptionSpec)defaultsTo)));
        Runtime.getRuntime().addShutdownHook(new lIIIIlIIIIIlllIllIII("Client Shutdown Thread"));
        Thread.currentThread().setName("Client thread");
        new Minecraft(llllIIIIlIIIlIlllIll).llllIIIIlIIIlIlllIll();
    }
