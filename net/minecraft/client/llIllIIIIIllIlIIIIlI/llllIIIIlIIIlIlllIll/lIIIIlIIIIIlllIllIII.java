...
class lIIIIlIIIIIlllIllIII extends IlIIIlIlIIIllIlIlIIl
{
    final /* synthetic */ llIllIIIIIllIlIIIIlI IIlllIlIIllIlIlIlIIl;
    
    public lIIIIlIIIIIlllIllIII(final llIllIIIIIllIlIIIIlI iIlllIlIIllIlIlIlIIl, final Minecraft minecraft) {
        ...
        for (final lIlIlIIIllIIllIIIllI lIlIlIIIllIIllIIIllI : net.minecraft.IIIlIIIlIlIIlllIIlll.IIIIlllIIIIIIlIIIlll.IlIIIlIlIIIllIlIlIIl) {
            boolean b = false;
            ...
            else if (net.minecraft.IIIlIIIlIlIIlllIIlll.IIIIlllIIIIIIlIIIlll.lllllIIIIIlIlIIIIIIl[llllIIIIlIIIlIlllIll] != null && iIlllIlIIllIlIlIlIIl.llIllIlIIIIllIlIIllI.llllIIIIlIIIlIlllIll(net.minecraft.IIIlIIIlIlIIlllIIlll.IIIIlllIIIIIIlIIIlll.lllllIIIIIlIlIIIIIIl[llllIIIIlIIIlIlllIll]) > 0) {
                b = true;
            }
        ...
        this.IlllllllIIIlIIIlIlII = new lIIIlllIIIllIIIllIII(this);
    }
    ...
    protected void llllIIIIlIIIlIlllIll(final int n, final int n2, final IIlllIIlllIIIlIlllII illlIIlllIIIlIlllII) {
        ...
        if (this.llllIIIIlIIIlIlllIll == 0) {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 115 - 18 + 1, n2 + 1 + 1, 72, 18);
        }
        else {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 115 - 18, n2 + 1, 72, 18);
        }
        if (this.llllIIIIlIIIlIlllIll == 1) {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 165 - 18 + 1, n2 + 1 + 1, 18, 18);
        }
        else {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 165 - 18, n2 + 1, 18, 18);
        }
        if (this.llllIIIIlIIIlIlllIll == 2) {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 215 - 18 + 1, n2 + 1 + 1, 36, 18);
        }
        else {
            this.IIlllIlIIllIlIlIlIIl.llIllIIIIIllIlIIIIlI(n + 215 - 18, n2 + 1, 36, 18);
        }
    }
    ...
    protected void llllIIIIlIIIlIlllIll(final int n, final int n2, final int n3, final int n4, final int n5, final int n6) {
        ...
        this.llllIIIIlIIIlIlllIll(net.minecraft.IIIlIIIlIlIIlllIIlll.IIIIlllIIIIIIlIIIlll.lllllIIIIIlIlIIIIIIl[llllIIIIlIIIlIlllIll2], n2 + 115, n3, n % 2 == 0);
        this.llllIIIIlIIIlIlllIll(net.minecraft.IIIlIIIlIlIIlllIIlll.IIIIlllIIIIIIlIIIlll.llIIIlIlllIllIIlIllI[llllIIIIlIIIlIlllIll2], n2 + 165, n3, n % 2 == 0);
