...
public class IIlllllIllIllIlIlIII extends IIIllllllIllIIIlllIl
{
    float llllIIIIlIIIlIlllIll;
    
    private IIlllllIllIllIlIlIII(final IlllllllIIIlIIIlIlII illlllllIIIlIIIlIlII, final double n, final double n2, final double n3, final double n4, final double n5, final double n6) {
        this(illlllllIIIlIIIlIlII, n, n2, n3, n4, n5, n6, 1.0f);
    }
    
    protected IIlllllIllIllIlIlIII(final IlllllllIIIlIIIlIlII illlllllIIIlIIIlIlII, final double n, final double n2, final double n3, final double n4, final double n5, final double n6, final float n7) {
        ...
        final float llIIlIIIlIIIllIlIIIl = (float)(Math.random() * 0.30000001192092896);
