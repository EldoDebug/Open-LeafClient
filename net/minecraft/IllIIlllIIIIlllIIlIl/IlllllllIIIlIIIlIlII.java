...
{
    protected IlllllllIIIlIIIlIlII(final int n, final lIllllIllIllIIllllll lIllllIllIllIIllllll, final int n2) {
        super(n, lIllllIllIllIIllllll, n2, net.minecraft.IllIIlllIIIIlllIIlIl.IlIlIllllllllIIIIlII.lIIIIlIIIIIlllIllIII);
        this.IlIlIlIlIlllllllllIl("untouching");
    }
    ...
    public boolean llllIIIIlIIIlIlllIll(final llllIIIIlIIIlIlllIll llllIIIIlIIIlIlllIll) {
        return super.llllIIIIlIIIlIlllIll(llllIIIIlIIIlIlllIll) && llllIIIIlIIIlIlllIll.IIlllIlIIllIlIlIlIIl != IlllllllIIIlIIIlIlII.IIllIIllIIIlIlIIIIlI.IIlllIlIIllIlIlIlIIl;
    }
