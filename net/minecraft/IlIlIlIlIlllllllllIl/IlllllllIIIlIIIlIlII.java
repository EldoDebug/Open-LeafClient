...
public class IlllllllIIIlIIIlIlII extends llllIIIIlIIIlIlllIll
{
    ...
    public void llllIIIIlIIIlIlllIll(final IllIlIIllIllIIlIllII illIlIIllIllIIlIllII, final String[] array) {
        if (array.length == 0) {
            final IlIIIlIlIIIllIlIlIIl ilIlIlIlIlllllllllIl = net.minecraft.IlIlIlIlIlllllllllIl.llllIIIIlIIIlIlllIll.IlIlIlIlIlllllllllIl(illIlIIllIllIIlIllII);
            ilIlIlIlIlllllllllIl.lllIllIIIllllllIllll();
            net.minecraft.IlIlIlIlIlllllllllIl.llllIIIIlIIIlIlllIll.llllIIIIlIIIlIlllIll(illIlIIllIllIIlIllII, this, "commands.kill.successful", ilIlIlIlIlllllllllIl.v_());
        }
        else {
            final llIllIIIIIllIlIIIIlI ilIlIlIlIlllllllllIl2 = net.minecraft.IlIlIlIlIlllllllllIl.llllIIIIlIIIlIlllIll.IlIlIlIlIlllllllllIl(illIlIIllIllIIlIllII, array[0]);
            ilIlIlIlIlllllllllIl2.lllIllIIIllllllIllll();
            net.minecraft.IlIlIlIlIlllllllllIl.llllIIIIlIIIlIlllIll.llllIIIIlIIIlIlllIll(illIlIIllIllIIlIllII, this, "commands.kill.successful", ilIlIlIlIlllllllllIl2.v_());
        }
    }
