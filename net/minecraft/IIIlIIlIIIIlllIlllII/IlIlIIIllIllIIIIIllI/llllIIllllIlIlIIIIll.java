...
public class llllIIllllIlIlIIIIll extends IlIlIIIllIIllIlllllI
{
                        ...
                        for (int n33 = n30; !b3 && n33 < n31; ++n33) {
                            for (int n34 = n29 + 1; !b3 && n34 >= n28 - 1; --n34) {
                                if (n34 >= 0 && n34 < 128) {
                                    ...
                                    if (llllIIIIlIIIlIlllIll2.llIllIIIIIllIlIIIIlI() == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.llIllIlIIIIllIlIIllI || llllIIIIlIIIlIlllIll2.llIllIIIIIllIlIIIIlI() == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.lIlIlIIIllIIllIIIllI) {
                                        b3 = true;
                                    }
                            ...
                            for (int k = n30; k < n31; ++k) {
                                ...
                                for (int l = n29; l > n28; --l) {
                                    ...
                                    if (n37 > -0.7 && n35 * n35 + n37 * n37 + n36 * n36 < 1.0) {
                                        ...
                                        if (llllIIIIlIIIlIlllIll3.llIllIIIIIllIlIIIIlI() == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.llllIlIllllIIlIIlIlI || llllIIIIlIIIlIlllIll3.llIllIIIIIllIlIIIIlI() == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.IlIIIlIlIIIllIlIlIIl || llllIIIIlIIIlIlllIll3.llIllIIIIIllIlIIIIlI() == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.llIllIIIIIllIlIIIIlI) {
    ...
    protected void llllIIIIlIIIlIlllIll(final IlllllllIIIlIIIlIlII illlllllIIIlIIIlIlII, final int n, final int n2, final int n3, final int n4, final IllIIlllIIIIlllIIlIl illIIlllIIIIlllIIlIl) {
        int nextInt = this.IlIlIlIlIlllllllllIl.nextInt(this.IlIlIlIlIlllllllllIl.nextInt(this.IlIlIlIlIlllllllllIl.nextInt(10) + 1) + 1);
        if (this.IlIlIlIlIlllllllllIl.nextInt(5) != 0) {
            nextInt = 0;
        }
        for (int i = 0; i < nextInt; ++i) {
            final double n5 = n * 16 + this.IlIlIlIlIlllllllllIl.nextInt(16);
            final double n6 = this.IlIlIlIlIlllllllllIl.nextInt(128);
            ...
            for (int j = 0; j < n8; ++j) {
                this.llllIIIIlIIIlIlllIll(this.IlIlIlIlIlllllllllIl.nextLong(), n3, n4, illIIlllIIIIlllIIlIl, n5, n6, n7, (this.IlIlIlIlIlllllllllIl.nextFloat() * 2.0f + this.IlIlIlIlIlllllllllIl.nextFloat()) * 2.0f, this.IlIlIlIlIlllllllllIl.nextFloat() * 3.1415927f * 2.0f, (this.IlIlIlIlIlllllllllIl.nextFloat() - 0.5f) * 2.0f / 8.0f, 0, 0, 0.5);
            }
        }
    }
}
