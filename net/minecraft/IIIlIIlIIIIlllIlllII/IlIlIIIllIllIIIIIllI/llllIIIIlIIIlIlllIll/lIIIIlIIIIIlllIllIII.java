...
public class lIIIIlIIIIIlllIllIII extends lllIllIIIllllllIllll
{
    private llllIIIIlIIIlIlllIll llllIIIIlIIIlIlllIll;
    private int IlIlIlIlIlllllllllIl;
    
    public lIIIIlIIIIIlllIllIII(final int ilIlIlIlIlllllllllIl) {
        this.llllIIIIlIIIlIlllIll = net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.IIlIlllIlIlllIlIllll;
            ...
            for (int j = ilIlIlIlIlllllllllIl.llIIlIIIlIIIllIlIIIl() - n; j <= ilIlIlIlIlllllllllIl.llIIlIIIlIIIllIlIIIl() + n; ++j) {
                ...
                if (n3 * n3 + n4 * n4 <= n * n) {
                    for (int k = ilIlIlIlIlllllllllIl.lIIIlllIIIllIIIllIII() - n2; k <= ilIlIlIlIlllllllllIl.lIIIlllIIIllIIIllIII() + n2; ++k) {
                        ...
                        if (llIllIIIIIllIlIIIIlI == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.IlIIIlIlIIIllIlIlIIl || llIllIIIIIllIlIIIIlI == net.minecraft.lIIIlllIIIllIIIllIII.llllIIIIlIIIlIlllIll.IIlIlllIlIlllIlIllll) {
