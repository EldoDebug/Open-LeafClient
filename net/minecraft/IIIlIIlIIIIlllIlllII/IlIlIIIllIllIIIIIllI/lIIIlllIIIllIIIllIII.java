...
public class lIIIlllIIIllIIIllIII implements JsonDeserializer, JsonSerializer
{
    ...
    public lIIIIlIIIIIlllIllIII llllIIIIlIIIlIlllIll(final JsonElement p0, final Type p1, final JsonDeserializationContext p2);
    
    public JsonElement llllIIIIlIIIlIlllIll(final lIIIIlIIIIIlllIllIII p0, final Type p1, final JsonSerializationContext p2);
}
