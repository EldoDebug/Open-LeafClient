...
public class IIllIIllIIIlIlIIIIlI extends llIllIlIlIIIIIIIllII
{
    public IIllIIllIIIlIlIIIIlI() {
        super(IlIlIIIllIllIIIIIllI.class, "cow", 0.7f);
    }
    ...
    public llllIIIlIlllIlIIIIIl llllIIIIlIIIlIlllIll(final IlIIIlIlIIIllIlIlIIl ilIIIlIlIIIllIlIlIIl, final float n) {
        return new llIllIlIIIIllIlIIllI(Minecraft.getMinecraft().lllllIIIIIlIlIIIIIIl(), ilIIIlIlIIIllIlIlIIl, n);
    }
}
