...
public class llIllIlIIIIllIlIIllI extends IIIIlllIIIIIIlIIIlll
{
    ...
    public void llllIIIIlIIIlIlllIll(final float n, final float n2, final float n3) {
        ...
        if (array[0] != n || array[1] != n2 || array[2] != n3) {
            array[0] = n;
            array[1] = n2;
            array[2] = n3;
            final int ilIlIIIllIllIIIIIllI = this.IlIlIIIllIllIIIIIllI();
            if (ilIlIIIllIllIIIIIllI >= 0) {
                ARBShaderObjects.glUniform3fARB(ilIlIIIllIllIIIIIllI, n, n2, n3);
    ...
    protected void llllIIIIlIIIlIlllIll(final int n) {
        ...
        if (this.llllIIIIlIIIlIlllIll[n] == null) {
            this.llllIIIIlIIIlIlllIll[n] = new float[] { -3.4028235E38f, -3.4028235E38f, -3.4028235E38f };
        }
    }
    
    @Override
    protected void IlIlIlIlIlllllllllIl() {
        this.llllIIIIlIIIlIlllIll = new float[][] { { -3.4028235E38f, -3.4028235E38f, -3.4028235E38f } };
    }
}
